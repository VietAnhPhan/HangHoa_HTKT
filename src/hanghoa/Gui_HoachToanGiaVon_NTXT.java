 ...
 * @author HaiTruong
 */
public class Gui_HoachToanGiaVon_NTXT extends javax.swing.JFrame {
    public static String mschaa;
    public static String tenchaa;
    /**
     * Creates new form Gui_CuaHang
     */
    public Gui_HoachToanGiaVon_NTXT() {
        initComponents();
        loadData();
    }
    ...
    private void initComponents() {
        ...
        JD_ngaybatdau = new com.toedter.calendar.JDateChooser();
        jLabel7 = new javax.swing.JLabel();
        JD_ngaykethuc = new com.toedter.calendar.JDateChooser();
        ...
        jLabel1.setText("Hoạch toán giá vốn - Nhập trước xuất trước");
        ...
        JD_ngaybatdau.setDateFormatString("yyyy-MM-dd");

        jLabel7.setText("Ngày kết thúc: ");

        JD_ngaykethuc.setDateFormatString("yyyy-MM-dd");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(JD_ngaykethuc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(JD_ngaybatdau, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel6)
                    .addComponent(JD_ngaybatdau, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel7)
                    .addComponent(JD_ngaykethuc, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btn_ChonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ChonActionPerformed
        ...
        do{
            ...
            if(JD_ngaybatdau.getDate()==null){
                java.util.Date date = new Date();
           
            JD_ngaybatdau.setDate(date);
            JOptionPane.showConfirmDialog(this,"Thiếu thời gian","Chú ý", JOptionPane.YES_NO_OPTION);
            }
        }while(JD_ngaybatdau.getDate()==null);
        BUS_Report br=new BUS_Report();
       
//                br.setVisible(true);
//                mschaa = cb_msch.getSelectedItem().toString();
//                tenchaa = t_TenCH.getText();
                    String mach=cb_msch.getSelectedItem().toString();
                    Date date=JD_ngaybatdau.getDate();
                    Date ngaykt=JD_ngaykethuc.getDate();
                     br.ReportBQGQ(mach, ngaykt, ngaykt);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gui_HoachToanGiaVon_NTXT().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private com.toedter.calendar.JDateChooser JD_ngaybatdau;
    private com.toedter.calendar.JDateChooser JD_ngaykethuc;

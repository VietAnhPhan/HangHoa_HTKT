 ...
 * @author HaiTruong
 */
public class Gui_HoachToanGiaVon_BQGQ extends javax.swing.JFrame {
    public static String mschaa;
    public static String tenchaa;
    /**
     * Creates new form Gui_CuaHang
     */
    public Gui_HoachToanGiaVon_BQGQ() {
        initComponents();
        loadData();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hoạch toán giá vốn - Bình quân gia quyền");
...
//                tenchaa = t_TenCH.getText();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gui_HoachToanGiaVon_BQGQ().setVisible(true);
            }
        });
    }
